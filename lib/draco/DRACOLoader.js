...
// |dracoPath| sets the path for the Draco decoder & encoder source files. The default
...
THREE.DRACOLoader = function(dracoPath, dracoDecoderType, manager) {
    ...
    if (typeof DracoEncoderModule === 'undefined') {
      THREE.DRACOLoader.loadDracoEncoder(this);
    }
...
//Load DracoEncoder only js file
THREE.DRACOLoader.loadDracoEncoder = function(dracoEncoder) {
  THREE.DRACOLoader.loadJavaScriptFile(dracoEncoder.dracoSrcPath +
    'draco_encoder.js', null, dracoEncoder);
}
